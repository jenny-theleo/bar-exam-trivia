...
const CRIMINAL_QUESTIONS = [
  { id: 4001, category: "Criminal Law and Procedure", question: "A woman and her sister took a trip to the Caribbean. When they passed through U.S. Customs inspection upon their return, the customs officials found liquid cocaine in several bottles each of them was carrying. They were arrested. Upon separate questioning by customs officers, the woman broke down and cried, \"I told my sister there were too many officers at this airport.\" The sister did not give a statement.\n\nThe woman and her sister were indicted for conspiracy to import cocaine. They were tried separately. At the woman's trial, after the government introduced the above evidence and rested its case, her lawyer moved for a judgment of acquittal on grounds of insufficient evidence.\n\nShould the court grant the motion?", answers: ["(A) No, because the evidence shows that both the woman and her sister agreed to import cocaine.", "(B) No, because the evidence shows that both the woman and her sister possessed cocaine.", "(C) Yes, because the evidence shows only that the woman and her sister committed separate crimes of cocaine possession.", "(D) Yes, because the evidence shows that the woman effectively withdrew from the conspiracy when she cooperated by giving a statement."], correct: "A" },
  { id: 4002, category: "Criminal Law and Procedure", question: "A man and his friend were watching a televised football game at the man's home. Upset by a penalty called by the referee, the friend threw a bottle of beer at the man's television, breaking the screen. Enraged, the man picked up a nearby hammer and hit the friend on the head with it. The friend died from the blow.\n\nThe crimes below are listed in descending order of seriousness.\n\nIn a jurisdiction that follows common law principles, what is the most serious crime of which the man could properly be convicted?", answers: ["(A) Murder.", "(B) Voluntary manslaughter.", "(C) Involuntary manslaughter.", "(D) Assault."], correct: "A" },
  { id: 4003, category: "Criminal Law and Procedure", question: "A man had spent the evening drinking at a local bar and was weaving down the street on his way home, singing. Suddenly, a person wearing a cartoon character mask jumped out from an alley, pointed his gun at the man, and snarled, \"This is loaded, buddy, and I don't mind using it. Hand over your cash pronto.\" The man was so drunk that he failed to understand what was going on and started to howl with laughter at the sight of the cartoon mask. Surprised and rattled by the man's reaction, the masked gunman fled. The man soon recovered his composure and staggered home safely.\n\nThe crimes below are listed in descending order of seriousness.\n\nWhat is the most serious crime of which the masked gunman may properly be charged and convicted?", answers: ["(A) Attempted robbery.", "(B) Attempted battery.", "(C) Attempted larceny.", "(D) No crime."], correct: "A" },
  { id: 4004, category: "Criminal Law and Procedure", question: "A common law jurisdiction defines first-degree murder as any murder that is (1) committed by means of poison or (2) premeditated. All other murder is second-degree murder, and manslaughter is defined as at common law.\n\nAn employee was angry with her boss for denying her a raise. Intending to cause her boss discomfort, the employee secretly dropped into his coffee three over-the-counter laxative pills. The boss drank the coffee containing the pills. Although the pills would not have been dangerous to an ordinary person, because the boss was already taking other medication, he suffered a seizure and died.\n\nIf the employee is charged with murder in the first degree, should she be convicted?", answers: ["(A) Yes, only because she used poison.", "(B) Yes, only because she acted with premeditation.", "(C) Yes, both because she used poison and because she acted with premeditation.", "(D) No."], correct: "D" },
  { id: 4005, category: "Criminal Law and Procedure", question: "A man asked his girlfriend to lend him something he could use to break into his neighbor's padlocked storage shed in order to steal a lawn mower. She handed him a crowbar. He took the crowbar but then found a bolt cutter that the neighbor had left outside the shed. Using the bolt cutter, he cut the padlock on the shed and took the mower, which he then used to mow his girlfriend's lawn. She was surprised and pleased by this gesture.\n\nBurglary in the jurisdiction applies to any structure or building, and there is no nighttime element.\n\nThe girlfriend has been charged as an accomplice to burglary and larceny.\n\nOf which crimes, if any, is she guilty?", answers: ["(A) Burglary and larceny.", "(B) Burglary, but not larceny, because she intended to assist only in the breaking.", "(C) Larceny, but not burglary, because she provided no actual assistance to the breaking but received a benefit from the larceny.", "(D) Neither burglary nor larceny, because she provided no actual assistance."], correct: "A" },
  { id: 4006, category: "Criminal Law and Procedure", question: "A defendant was tried for armed robbery. The state introduced evidence that a man, identified by witnesses as the defendant, entered a convenience store at 11 p.m. on March 5, threatened the clerk with a gun, and took $75 from the cash register.\n\nThe defendant did not testify, but his sister did. She testified that on March 5, at the time of the robbery, the defendant was with her in a city 300 miles away. On cross-examination, the sister admitted having given a statement to the police in which she had said that the defendant was not with her on March 5, but she claimed that the earlier statement was mistaken.\n\nThe court instructed the jury that in order to convict the defendant, they had to find all of the elements of the crime beyond a reasonable doubt.\n\nAs to the defendant's claim of alibi, which of the following additional instructions would be proper?", answers: ["(A) Alibi is a matter of defense and so must be established by the defendant; however, the burden of persuasion is by a preponderance of the evidence, not beyond a reasonable doubt.", "(B) Before you may consider the defendant's claim of alibi, you must decide whether he has produced sufficient evidence to raise the issue.", "(C) If you have a reasonable doubt as to whether the defendant was present at the convenience store at about 11 p.m. on March 5, you must find him not guilty.", "(D) If the defendant's evidence has caused you to have a reasonable doubt as to whether he was the robber, you must find him not guilty."], correct: "C" },
  { id: 4007, category: "Criminal Law and Procedure", question: "While on their way home from a ball game, a driver and his passenger stopped at an all-night gas station. The passenger offered to pay for the gas. While the passenger pumped gas, he was surprised to see the driver enter the station, take money from the unattended cash drawer, and get back in the car. The passenger paid the attendant for the gas, and the driver drove off. The driver offered to reimburse the passenger for the gas, but the passenger declined. After discovering the missing cash, the gas station attendant called the police, and the driver was later stopped. The driver escaped with the stolen money, however, and was never prosecuted.\n\nIf the passenger is prosecuted for theft as an accomplice, should he be convicted?", answers: ["(A) No, because he had no intent to promote the commission of the offense.", "(B) No, because the driver, the principal, was never prosecuted.", "(C) Yes, because he facilitated commission of the offense by failing to make any effort to stop it.", "(D) Yes, because he paid the attendant while he knew the driver was holding the stolen money."], correct: "A" },
  { id: 4008, category: "Criminal Law and Procedure", question: "An undercover police detective told a local drug dealer that she wanted to buy cocaine, but that she needed time to raise the necessary funds. The drug dealer said that he needed time to get the cocaine. They agreed to meet again in ten days. An hour later, without a warrant, other officers forcibly entered the drug dealer's apartment and arrested him for attempted possession of a controlled substance.\n\nIf the drug dealer is prosecuted in a common-law jurisdiction for attempted possession of cocaine, should he be convicted?", answers: ["(A) No, because he had not taken sufficient acts toward commission of the crime.", "(B) No, because he was illegally arrested.", "(C) Yes, because by objective standards an agreement between them had occurred.", "(D) Yes, because his intention to obtain the cocaine was unequivocally expressed."], correct: "A" },
  { id: 4009, category: "Criminal Law and Procedure", question: "One evening, a woman was driving above the speed limit on a country road. As she rounded a sharp curve, she lost control of the car and crossed over to the shoulder on the other side of the road. Her car hit a truck that was parked on the shoulder with its hood up while its driver waited for a tow truck. The force of the collision threw the driver out of the truck and down an embankment. The driver died from his injuries.\n\nDriving above the speed limit and causing an accident can be charged as reckless driving, a misdemeanor in the jurisdiction.\n\nWhat is the most serious homicide offense, if any, of which the woman can properly be convicted?", answers: ["(A) Murder, based on malice aforethought.", "(B) Voluntary manslaughter, based on reckless operation of a vehicle.", "(C) Involuntary manslaughter, based on the misdemeanor of reckless driving.", "(D) No homicide offense."], correct: "C" },
  { id: 4010, category: "Criminal Law and Procedure", question: "After being fired from his job, the defendant drank almost a quart of vodka and decided to ride the bus home. While on the bus, he saw a briefcase he mistakenly thought was his own, and began struggling with the passenger carrying the briefcase. The defendant knocked the passenger to the floor, took the briefcase, and fled. The defendant was arrested and charged with robbery.\n\nThe defendant should be", answers: ["(A) acquitted, because he used no threats and was intoxicated.", "(B) acquitted, because his mistake negated the required specific intent.", "(C) convicted, because his intoxication was voluntary.", "(D) convicted, because mistake is no defense to robbery."], correct: "B" },
  { id: 4011, category: "Criminal Law and Procedure", question: "While browsing in a clothing store, a thief decided to take a purse without paying for it. She placed the purse under her coat and took a couple of steps toward the exit. She then realized that a sensor tag on the purse would set off an alarm. She placed the purse near the counter from which she had removed it.\n\nThe thief has committed", answers: ["(A) no crime, because the purse was never removed from the store.", "(B) no crime, because she withdrew from her criminal enterprise.", "(C) only attempted larceny, because she intended to take the purse out of the store.", "(D) larceny, because she took the purse from its original location and concealed it with the intent to steal."], correct: "D" },
  { id: 4012, category: "Criminal Law and Procedure", question: "An employee decided to kill his boss, after she told him that he would be fired if his work did not improve. The employee knew his boss was scheduled to go on a business trip on Monday morning. On Sunday morning, the employee went to the company parking garage and put a bomb in the company car that his boss usually drove. The bomb was wired to go off when the car engine started. The employee then left town. At 5 a.m. Monday, the employee, after driving all night, was overcome with remorse and had a change of heart. He called the security officer on duty at the company and told him about the bomb. The security officer said he would take care of the matter. An hour later, the officer put a note on the boss' desk telling her of the message. He then looked at the car but could not see any signs of a bomb. He printed a sign saying \"DO NOT USE THIS CAR,\" put it on the windshield, and went to call the police. Before the police arrived, a company vice-president (not the boss) got into the car and started the engine. The bomb went off, killing her.\n\nThe jurisdiction defines murder in the first degree as any homicide committed with premeditation and deliberation or any murder in the commission of a common-law felony. Second-degree murder is defined as all other murder at common law. Manslaughter is defined by the common law. The employee is guilty of", answers: ["(A) murder in the first degree, because, with premeditation and deliberation, he killed whoever would start the car.", "(B) murder in the second degree, because he had no intention of killing the company vice-president.", "(C) manslaughter, because at the time of the explosion, he had no intent to kill, and the death of the company vice-president was in part the fault of the security officer.", "(D) only attempted murder of the boss, because the death of the company vice-president was the result of the security officer's negligence."], correct: "A" },
  { id: 4013, category: "Criminal Law and Procedure", question: "A student and his friend were watching a football game at the student's home when they began to argue. The friend became abusive, and the student asked him to leave. The friend refused, walked into the kitchen, picked up a knife, and said he would cut the student's heart out. The student pulled a gun from under the sofa, walked to his front door, opened it, and again told the friend to leave. The friend again refused. Instead, he walked slowly toward the student, brandishing the knife in a threatening manner. The student, rather than running out the door himself, shot in the friend's direction, intending only to scare him. However, the bullet struck the friend, killing him instantly.\n\nCharged with murder, the student should be", answers: ["(A) convicted, because the use of deadly force was unreasonable under the circumstances.", "(B) convicted, because he had a clear opportunity and duty to retreat.", "(C) acquitted, because he did not intend to kill the friend.", "(D) acquitted, because he was acting in self-defense and had no duty to retreat."], correct: "D" },
  { id: 4014, category: "Criminal Law and Procedure", question: "In a criminal trial, the evidence showed that the defendant's neighbor tried to kill the defendant by stabbing him. The defendant ran to his room, picked up a gun, and told his neighbor to back off. The neighbor did not, but continued her attack and stabbed him in the arm. The defendant then shot the neighbor twice. The neighbor fell to the floor and lay quietly moaning. After a few seconds, the defendant fired a third shot into the neighbor. The jury found that the neighbor died instantly from the third shot and that the defendant was no longer in fear of being attacked by her.\n\nThe defendant could properly be convicted of which of the following degrees of criminal homicide, if any?", answers: ["(A) Attempted murder only.", "(B) Manslaughter only.", "(C) Murder or manslaughter.", "(D) No degree of criminal homicide."], correct: "C" },
  { id: 4015, category: "Criminal Law and Procedure", question: "A computer analyst admired his co-worker's wristwatch and frequently said how much he wished he had one like it. The co-worker decided to give the computer analyst the watch for his birthday the following week.\n\nOn the weekend before the computer analyst's birthday, the computer analyst and the co-worker attended a company picnic. The co-worker took his watch off and left it on a blanket when he went off to join in a touch football game. The computer analyst strolled by, saw the watch on the blanket, and decided to steal it. He bent over and picked up the watch. Before he could pocket it, however, the co-worker returned. When he saw the computer analyst holding the watch, he said, \"I know how much you like that watch. I was planning to give it to you for your birthday. Go ahead and take it now.\" The computer analyst kept the watch. The computer analyst has committed", answers: ["(A) larceny.", "(B) attempted larceny.", "(C) embezzlement.", "(D) no crime."], correct: "A" },
  { id: 4016, category: "Criminal Law and Procedure", question: "A babysitter, while babysitting one night, noticed that the neighbor, who lived next door, had left his house but that the door did not close completely behind him. The babysitter said to the 11-year-old boy she was babysitting, \"Let's play a game. You go next door and see if you can find my portable television set, which I lent to the neighbor, and bring it over here.\" The babysitter knew that the neighbor had a portable television set, and the babysitter planned to keep the set for herself. The boy thought the set belonged to his babysitter, went next door, found the television set, and carried it out the front door. At that moment, the neighbor returned home and discovered the boy in his front yard with the television set. The boy explained the \"game\" he and the babysitter were playing. The neighbor took back his television set and called the police.\n\nThe babysitter is", answers: ["(A) not guilty of larceny or attempted larceny, because the boy did not commit any crime.", "(B) not guilty of larceny but guilty of attempted larceny, because she never acquired possession of the television set.", "(C) guilty of larceny as an accessory to the boy.", "(D) guilty of larceny by the use of an innocent agent."], correct: "D" },
  { id: 4017, category: "Criminal Law and Procedure", question: "At 11:00 p.m., a husband and his wife were accosted in the entrance to their apartment building by the defendant, who was armed as well as masked. The defendant ordered the couple to take him into their apartment. After they entered the apartment, the defendant forced the wife to bind and gag her husband and then to open a safe which contained a diamond necklace. The defendant then tied her up and fled with the necklace. He was apprehended by apartment building security guards. Before the guards could return to the apartment, but after the defendant was arrested, the husband, straining to free himself, suffered a massive heart attack and died.\n\nThe defendant is guilty of", answers: ["(A) burglary, robbery, and murder.", "(B) robbery and murder only.", "(C) burglary and robbery only.", "(D) robbery only."], correct: "A" },
  { id: 4018, category: "Criminal Law and Procedure", question: "A jail inmate wanted to make some money, so she decided to sell cocaine. She asked her friend, who was reputed to have access to illegal drugs, to supply her with cocaine so she could resell it. The friend agreed and sold the inmate a bag of white powder. The inmate then repackaged the white powder into smaller containers and sold one to an undercover police officer, who promptly arrested the inmate. The inmate immediately confessed and said that her friend was her supplier.\n\nIf the friend knew the white powder was not cocaine but the inmate believed it was, which of the following is correct?", answers: ["(A) Both the friend and the inmate are guilty of attempting to sell cocaine.", "(B) Neither the friend nor the inmate is guilty of attempting to sell cocaine.", "(C) The friend is guilty of attempting to sell cocaine, but the inmate is not.", "(D) The friend is not guilty of attempting to sell cocaine, but the inmate is."], correct: "D" },
  { id: 4019, category: "Criminal Law and Procedure", question: "A businessman lived on the second floor of a small convenience store/gas station that he owned. One night he refused to sell a customer a six-pack of beer after hours, saying he could not violate the state laws. The customer became enraged and deliberately drove his car into one of the gasoline pumps, severing it from its base. There was an ensuing explosion causing a ball of fire to go from the underground gasoline tank into the building. As a result, the building burned to the ground and the businessman was killed.\n\nIn a common-law jurisdiction, if the customer is charged with murder and arson, he should be", answers: ["(A) convicted of both offenses.", "(B) convicted of involuntary manslaughter and acquitted of arson.", "(C) convicted of arson and involuntary manslaughter.", "(D) acquitted of both offenses."], correct: "A" },
  { id: 4020, category: "Criminal Law and Procedure", question: "A defendant is charged with murder. The evidence shows that she pointed a gun at the victim and pulled the trigger. The gun discharged, killing the victim. The gun belonged to the victim.\n\nThe defendant testifies that the victim told her, and she believed, that the \"gun\" was a stage prop that could fire only blanks, and that she fired the gun as part of rehearsing a play with the victim at his house. If the jury believes the defendant's testimony and finds that her mistaken belief that the gun was a prop was reasonable, they should find her", answers: ["(A) guilty of murder.", "(B) guilty of manslaughter.", "(C) guilty of either murder or manslaughter.", "(D) not guilty of murder or manslaughter."], correct: "D" },
  { id: 4021, category: "Criminal Law and Procedure", question: "A college student approached an undercover police officer and inquired about hiring someone to kill his girlfriend's parents. Unknown to the college student, the police officer pretended to agree to handle the job and secretly taped subsequent conversations with the college student concerning plans and payment. A few days before the payment was due, the college student changed his mind and called the plan off. Nevertheless, the college student was charged with solicitation to commit murder.\n\nThe college student should be", answers: ["(A) acquitted, because he withdrew before payment.", "(B) acquitted, because no substantial acts were performed.", "(C) convicted, because the offense was completed before his attempt to withdraw.", "(D) convicted, because the police officer agreed to commit the offense."], correct: "C" },
  { id: 4022, category: "Criminal Law and Procedure", question: "A homeless young woman broke into the basement of a hotel and fell asleep. She was awakened by a security guard, who demanded that she leave. As the young woman was leaving, she cursed the security guard. Angered, the guard began to beat the young woman on her head with his flashlight. After the second blow, the young woman grabbed a fire extinguisher and sprayed the guard in his face, causing him to lose his sight in one eye.\n\nThe jurisdiction defines aggravated assault as assault with intent to cause serious bodily injury. The most serious crime for which the young woman could properly be convicted is", answers: ["(A) aggravated assault.", "(B) burglary.", "(C) assault.", "(D) trespass."], correct: "D" },
  { id: 4023, category: "Criminal Law and Procedure", question: "A gangster and two of his friends were members of a teenage street gang. While they were returning from a dance late one evening, their car collided with a car driven by an elderly woman. After an argument, the gangster attacked the elderly woman with his fists and beat her to death. The two friends watched, and when they saw the woman fall to the ground they urged the gangster to flee. The gangster was eventually apprehended and tried for manslaughter, but the jury could not decide on a verdict.\n\nIf the gangster's companions are subsequently tried as accomplices to manslaughter, they should be", answers: ["(A) acquitted, because the gangster was not convicted of the offense.", "(B) acquitted, because they did not assist or encourage the gangster to commit the crime.", "(C) convicted, because they urged him to flee.", "(D) convicted, because they made no effort to intervene."], correct: "B" },
  { id: 4024, category: "Criminal Law and Procedure", question: "Four men are charged with conspiracy to commit a series of bank robberies. Nine successful bank robberies took place during the period of the charged conspiracy. Because the robbers wore masks and gloves and stole the bank surveillance tapes, no direct identification of the robbers by the witnesses has been made. Some circumstantial evidence ties each of the men to the overall conspiracy. During cross-examination, a prosecution witness testified that one defendant was in jail on other charges during six of the robberies. That defendant's lawyer has moved for a judgment of acquittal at the close of the government's case.\n\nShould the motion be granted?", answers: ["(A) No, because a conspirator is not required to agree to all of the objects of the conspiracy.", "(B) No, because a conspirator need not be present at the commission of each crime conspired upon.", "(C) Yes, provided the defendant has complied with the rule requiring pretrial notice of alibi.", "(D) Yes, regardless of compliance with the alibi rule, because the government is bound by exculpatory evidence elicited during its case in chief."], correct: "B" },
  { id: 4025, category: "Criminal Law and Procedure", question: "A defendant was indicted and arrested for bank robbery. The defendant had an initial appearance before a magistrate judge in which he was notified of the charges and told that counsel would be appointed for him the next day. The police then required the defendant to participate with other prisoners in a lineup in which each person had to wear a white T-shirt and say, \"Put your hands in the air.\" At the lineup, witnesses to the bank robbery identified the defendant as the bank robber. The next day, the defendant was arraigned on the charges.\n\nThe defendant argues that his Sixth Amendment right to counsel was violated when he was denied counsel at two critical stages of the proceeding: his initial appearance in court before the magistrate judge and the lineup identification.\n\nWas the defendant's Sixth Amendment right to counsel violated?", answers: ["(A) No.", "(B) Yes, based only on the denial of counsel at the initial appearance.", "(C) Yes, based only on the denial of counsel at the lineup.", "(D) Yes, based on the denial of counsel at both stages of the proceeding."], correct: "C" },
  { id: 4026, category: "Criminal Law and Procedure", question: "In a trial of a defendant for armed bank robbery, the prosecutor presented overwhelming evidence of guilt. Three tellers identified the defendant as the robber, a latent fingerprint found on the bank counter linked the defendant to the scene, and bank money had been found in the defendant's car. The police had arrested the defendant immediately after the robbery, as the defendant was driving away from the bank.\n\nWhen the prosecution rested its case, the judge directed the jury to return a verdict of guilty. The defense attorney did not object at the time. The jury withdrew, discussed the case, and agreed to a guilty verdict. The jury returned to the courtroom and announced the guilty verdict. The defense attorney then voiced an objection to the judge's having directed the verdict. The court overruled the objection and sentenced the defendant to 20 years in prison.\n\nOn appeal, what should the appellate court do?", answers: ["(A) Affirm the conviction, because the defense attorney failed to timely object to the judge's action.", "(B) Affirm the conviction, because the prosecution presented both circumstantial and direct evidence conclusively establishing the defendant's guilt.", "(C) Reverse the conviction, because the defense attorney's failure to timely object to the judge's action constituted ineffective assistance of counsel.", "(D) Reverse the conviction, because the judge's action in directing the verdict denied the defendant his constitutional right to a trial by jury."], correct: "D" },
  { id: 4027, category: "Criminal Law and Procedure", question: "A state statute provides that the crime of assault is generally punishable by a maximum of five years in prison. It further provides that the maximum punishment increases to 10 years in prison if the defendant possessed a deadly weapon during the assault. The statute designates the deadly weapon element as a sentencing factor.\n\nA defendant charged with assault has pleaded not guilty and has requested a jury trial. The prosecutor has announced that she will be seeking a 10-year sentence based on the defendant's alleged possession of a deadly weapon.\n\nWhat finding regarding the defendant's possession of a deadly weapon is necessary for the court to impose a 10-year sentence?", answers: ["(A) A judicial finding by a preponderance of the evidence.", "(B) A jury finding by a preponderance of the evidence.", "(C) A judicial finding beyond a reasonable doubt.", "(D) A jury finding beyond a reasonable doubt."], correct: "D" },
  { id: 4028, category: "Criminal Law and Procedure", question: "A police officer stopped a driver who had run a red light. Upon approaching the car, the officer noticed a strong odor of alcohol and immediately asked whether the driver had been drinking. The driver admitted having had several alcoholic drinks that evening.\n\nThe driver, charged with driving while intoxicated, moved to suppress the officer's testimony regarding the driver's statement about his drinking. The driver argued that the officer had elicited the statement without providing the requisite Miranda warnings. The prosecutor has responded that the statement should be allowed in the prosecution's case-in-chief or, at a minimum, should be allowed as impeachment in the event the driver testifies and denies drinking.\n\nHow should the court rule regarding the driver's statement admitting his drinking?", answers: ["(A) The statement should be allowed, because although the driver was in custody, the officer's spontaneous utterance upon smelling alcohol did not rise to the level of interrogation.", "(B) The statement should be allowed, because the driver was not in custody for Miranda purposes when the admission was made.", "(C) The statement should be suppressed both in the prosecution's case-in-chief and as impeachment evidence, even if the driver testifies.", "(D) The statement should be suppressed in the prosecution's case-in-chief, but it may be used as impeachment evidence if the driver testifies."], correct: "B" },
  { id: 4029, category: "Criminal Law and Procedure", question: "Four hours into a defendant's assault trial, the lawyers gathered in the judge's chambers to discuss an evidentiary issue. While there, the judge received a phone call from his wife telling him that her mother had suddenly died. Without asking the lawyers what they wanted to do, the judge brought the lawyers back into the courtroom, declared a mistrial, excused the jury, and rushed home to his wife.\n\nA new jury was impaneled the next day before a second judge. The defendant has objected to the second trial on double jeopardy grounds.\n\nWould the second trial violate the prohibition against double jeopardy?", answers: ["(A) No, because the first judge acted in good faith in declaring a mistrial.", "(B) No, because the first trial did not produce a verdict.", "(C) Yes, because the second judge's evidentiary rulings might be inconsistent with those of the first judge.", "(D) Yes, because there was no manifest necessity for a mistrial."], correct: "D" },
  { id: 4030, category: "Criminal Law and Procedure", question: "Police officers had probable cause to believe that a man had committed a series of armed bank robberies with an accomplice.\n\nThe officers obtained a valid arrest warrant for the man and went to his house to arrest him. The officers found the front door ajar and could hear a radio playing inside. They knocked on the door, identified themselves as police officers, and stated that they had a warrant. Getting no response, the officers entered the house. After the officers called the man's name several times and again identified themselves as police officers, the man emerged from the basement and was arrested. The officers went into the basement to look for the accomplice. They opened a closet door and found cocaine in plain view. They did not find the accomplice.\n\nThe man was indicted for cocaine possession. He has moved to suppress the cocaine as evidence on the ground that it was obtained in violation of the Fourth Amendment.\n\nShould the court grant the motion to suppress?", answers: ["(A) No, because the officers discovered the cocaine during a lawful protective sweep of the house looking for the man's accomplice.", "(B) No, because the search was incident to the man's arrest.", "(C) Yes, because the officers did not have a search warrant.", "(D) Yes, because the officers did not have probable cause to believe that cocaine would be in the closet."], correct: "A" },
  { id: 4031, category: "Criminal Law and Procedure", question: "Without a warrant, police officers searched the garbage cans in the alley behind a man's house and discovered chemicals used to make methamphetamine, as well as cooking utensils and containers with the man's fingerprints on them. The alley was a public thoroughfare maintained by the city, and the garbage was picked up once a week by a private sanitation company. The items were found inside the garbage cans in plastic bags that had been tied closed and further secured with tape. The man was charged in federal court with the manufacture of methamphetamine.\n\nDid the search of the garbage cans violate the Fourth Amendment?", answers: ["(A) No, because the man had no reasonable expectation of privacy in garbage left in the alley.", "(B) No, because the probative value of the evidence outweighs the man's modest privacy claims in his garbage.", "(C) Yes, because the alley was within the curtilage of the man's home and entry without a warrant was unconstitutional.", "(D) Yes, because there is a reasonable expectation of privacy in one's secured garbage containers."], correct: "A" },
  { id: 4032, category: "Criminal Law and Procedure", question: "A defendant was charged with armed robbery. The defendant had only an eighth-grade education and no legal knowledge.\n\nAt a pretrial hearing, the defendant told the judge that he was unhappy with the public defender who had been appointed to represent him and that he wanted the judge to appoint another lawyer. The judge refused to appoint another lawyer, telling the defendant, with no further explanation, that his only other choice was to represent himself. The defendant said that he would represent himself at trial then, as \"anything [was] better than having this lawyer.\"\n\nThe defendant did not raise the subject again, and he represented himself at trial. After hearing overwhelming evidence of the defendant's guilt, the jury convicted him of armed robbery. On appeal, the defendant has requested a new trial on the ground that he was deprived of his right to counsel.\n\nShould the appellate court grant the defendant's request?", answers: ["(A) No, because the defendant voluntarily waived his right to counsel.", "(B) No, because the trial court's error was harmless in light of the overwhelming evidence.", "(C) Yes, because the defendant was not capable of effectively representing himself.", "(D) Yes, because the record does not establish a valid waiver of the right to counsel."], correct: "D" },
  { id: 4033, category: "Criminal Law and Procedure", question: "A defendant was convicted of fraud after a jury trial in state court. The conviction was affirmed on direct appeal.\n\nThe defendant timely moved for post-conviction relief under the Sixth Amendment on the ground that his attorney had provided ineffective assistance of counsel. The trial judge, after a hearing, found that the attorney had performed deficiently by failing to raise a proper objection that would have resulted in exclusion of important prosecution evidence.\n\nWhat more, if anything, must the trial court find in order to sustain the defendant's Sixth Amendment claim?", answers: ["(A) Nothing more, because the unjustifiable failure to object to important prosecution evidence is structural error.", "(B) That the attorney was court-appointed and not privately retained.", "(C) That there is a reasonable probability that the trial's outcome would have been different if the attorney had objected.", "(D) That there is clear and convincing evidence that the trial's outcome would have been different if the attorney had objected."], correct: "C" },
  { id: 4034, category: "Criminal Law and Procedure", question: "A man kidnapped a victim in State A and transported the victim across the state border into State B. These actions violated the kidnapping laws of both states, which are identical. A jury convicted the man in a State A court, but the trial judge gave what prosecutors in State B deemed an unduly lenient sentence. The state prosecutor in State B then commenced a kidnapping case against the man for violating State B's kidnapping statute.\n\nThe man's lawyer has filed a motion in State B to dismiss the charge based on the double jeopardy protection against a second prosecution for the man's single act of kidnapping.\n\nShould the court grant the motion to dismiss?", answers: ["(A) No, because the double jeopardy protection only prohibits a second prosecution following an acquittal for the same offense.", "(B) No, because the man's conduct violated the laws of two different states, and each has the right to enforce its laws.", "(C) Yes, because the double jeopardy protection prohibits a second prosecution following a conviction for the same offense.", "(D) Yes, because the government is collaterally estopped under the double jeopardy protection from prosecuting a defendant a second time for the same conduct that led to an earlier conviction."], correct: "B" },
  { id: 4035, category: "Criminal Law and Procedure", question: "The police suspected a woman of dealing in stolen credit cards. An undercover police officer knocked on the woman's door and told her that he was willing to pay for usable credit cards. When the woman asked if he was a police officer, the officer replied, \"No,\" giving her a false name and saying, \"You can call Harvey — he'll vouch for me.\" The woman admitted him to her house. After she left the room to call Harvey, the officer lifted some papers off a desk and underneath discovered three credit cards bearing different names. He seized the cards, and when the woman returned, he arrested her.\n\nThe woman has moved to suppress the evidence seized on the ground that her Fourth Amendment rights were violated.\n\nShould the court grant the motion to suppress?", answers: ["(A) No, because it was immediately apparent that the cards were stolen.", "(B) No, because the woman assumed the risk that the officer would seize items in plain sight.", "(C) Yes, because the woman's rights were violated when the officer lifted the papers.", "(D) Yes, because the woman's rights were violated when the officer obtained entry by deceit."], correct: "C" },
  { id: 4036, category: "Criminal Law and Procedure", question: "A defendant was charged with and tried for murder. At trial, the defendant testified that he had acted in self-defense.\n\nThe trial court instructed the jury that the defendant had the burden of proving by a preponderance of the evidence that he had acted in self-defense. The defendant objected, arguing that this instruction violated the constitutional requirement that the prosecution prove the offense beyond a reasonable doubt.\n\nDid the trial court's instruction violate the defendant's federal constitutional rights?", answers: ["(A) No, because due process does not preclude requiring a defendant to prove self-defense by a preponderance of the evidence.", "(B) No, because due process does not regulate the burdens of proof in criminal cases.", "(C) Yes, because due process precludes placing any evidentiary burden on a criminal defendant.", "(D) Yes, because due process precludes requiring a criminal defendant to bear the burden on an issue that would make an act lawful."], correct: "A" },
  { id: 4037, category: "Criminal Law and Procedure", question: "A man was in jail after being arrested for burglary. When the police attempted to question him, the man invoked his Miranda rights and refused to answer any questions. The man was subsequently tried, convicted, and sentenced to a prison term for the burglary. Three years later, while the man was serving his prison sentence for the burglary, a police detective from a nearby town questioned him about an unsolved homicide. The detective did not know that the man had invoked Miranda at an earlier time. The man waived his Miranda rights and made several incriminating statements to the detective. When he was later charged with the homicide, the man moved to suppress these statements, claiming that his earlier refusal to waive his Miranda rights should have been honored.\n\nShould the court suppress the statements?", answers: ["(A) No, because the detective was unaware that the man had originally invoked his Miranda rights.", "(B) No, because the man's prior invocation of his Miranda rights did not preclude the later interrogation.", "(C) Yes, because the man had earlier invoked his Miranda rights, and the police were not permitted to resume questioning, even after a time lapse of years.", "(D) Yes, because the man was incarcerated, and his earlier invocation of his Miranda rights shielded him from further questioning until he was released."], correct: "B" },
  { id: 4038, category: "Criminal Law and Procedure", question: "A defendant, a 14-year-old male, was tried as an adult for an armed robbery and was convicted. No one had been physically harmed during the robbery. In light of the defendant's lengthy juvenile criminal history, which included violent offenses, and the fact that armed robbery is a crime of violence, he was sentenced to life in prison without the possibility of parole.\n\nDid the life-without-parole sentence violate the Eighth Amendment ban on cruel and unusual punishment?", answers: ["(A) No, because a juvenile may be sentenced to life without parole if release would pose a danger to the community.", "(B) No, because the Eighth Amendment does not apply outside the context of capital punishment.", "(C) Yes, because a life-without-parole sentence is not permissible for a juvenile defendant convicted of a non-homicide offense.", "(D) Yes, because a life-without-parole sentence is not permissible for an adult or juvenile defendant convicted of a nonviolent offense."], correct: "C" },
  { id: 4039, category: "Criminal Law and Procedure", question: "Police officers had probable cause to believe that drug dealing was routinely taking place in a particular room at a local motel. The motel manager authorized the officers to enter the room and provided them with a passkey. Without obtaining a warrant, the officers knocked on the room's door, announced their presence, and told the occupants that they would like to speak with them. The officers then heard yelling and repeated flushing of the toilet. They then used the passkey and entered the room, where they saw the occupants dumping drugs into the toilet. The occupants of the room were charged with drug dealing and have moved to suppress the drugs.\n\nShould the court grant the motion to suppress?", answers: ["(A) No, because exigent circumstances justified the officers' entry.", "(B) No, because the motel manager consented to the officers' entry.", "(C) Yes, because exigent circumstances cannot excuse the lack of a warrant.", "(D) Yes, because the officers cannot benefit from exigent circumstances that they created."], correct: "A" },
  { id: 4040, category: "Criminal Law and Procedure", question: "A federal grand jury was investigating a corporation whose tanker ship had spilled crude oil into environmentally sensitive waters. The grand jury issued a subpoena requiring the corporation to produce all emails and internal documents regarding the corporation's knowledge of the risks of an oil spill. The corporation has objected, citing its Fifth Amendment privilege against self-incrimination.\n\nCan the subpoena be enforced?", answers: ["(A) No, because the corporation was not granted transactional immunity.", "(B) No, because the corporation was not granted use-and-derivative-use immunity.", "(C) Yes, because a corporation has no Fifth Amendment privilege.", "(D) Yes, because the Fifth Amendment privilege does not apply to the compelled production of documents."], correct: "C" },
  { id: 4041, category: "Criminal Law and Procedure", question: "A man was charged with first-degree murder. Two lawyers were appointed to represent him because the prosecution planned to seek the death penalty. On the first day of trial, the air-conditioning malfunctioned in the courtroom, so the judge directed that the selection of the jurors take place in his chambers. Because of the large number of potential jurors, the judge directed that only one lawyer for the prosecution and one for the defense participate in the jury selection process. The defendant remained in the courtroom during the questioning of the jurors. Once the jury was selected, the trial was postponed until the next day, when the air-conditioning was again working.\n\nDid the court's jury selection process violate the defendant's federal constitutional rights?", answers: ["(A) No, because a defendant's confrontation rights are limited to witnesses rather than jurors.", "(B) No, because there was good cause to conduct jury selection outside the defendant's presence.", "(C) Yes, because excluding the defendant undercut the presumption of innocence.", "(D) Yes, because jury selection is a critical stage at which a defendant is entitled to be present."], correct: "D" },
  { id: 4042, category: "Criminal Law and Procedure", question: "A store owner whose jewelry store had recently been robbed was shown by a police detective a photograph of the defendant, who previously had committed other similar crimes. The store owner examined the photograph and then asked the detective whether the police believed that the man pictured was the robber. After the detective said, \"We're pretty sure,\" the store owner stated that the man in the photograph was the one who had robbed her.\n\nThe defendant was indicted for the robbery. His counsel moved to suppress any trial testimony by the store owner identifying the defendant as the robber.\n\nShould the court grant the motion and suppress the store owner's trial testimony identifying the defendant as the robber?", answers: ["(A) No, because suppression of in-court testimony is not a proper remedy, even though the out-of-court identification was improper.", "(B) No, because the out-of-court identification was not improper.", "(C) Yes, because the improper out-of-court identification has necessarily tainted any in-court identification.", "(D) Yes, unless the prosecution demonstrates that the in-court identification is reliable."], correct: "D" },
  { id: 4043, category: "Criminal Law and Procedure", question: "A defendant was charged with attempted murder. At the preliminary hearing, the presiding judge heard the testimony of four prosecution witnesses and found that the prosecution had failed to establish probable cause that the defendant had committed any offense. Accordingly, he dismissed the charge.\n\nThe prosecutor then called the same four witnesses before a grand jury. The grand jury indicted the same defendant for attempted murder.\n\nThe defendant has moved to quash the indictment on the ground of double jeopardy.\n\nHow should the court proceed?", answers: ["(A) Grant the motion, because the dismissal of the first charge on the merits, whether correct or incorrect, bars any further prosecution.", "(B) Grant the motion, unless the prosecution has evidence that was not presented in the first case.", "(C) Deny the motion, because the defendant has not yet been in jeopardy of conviction on the attempted murder charge.", "(D) Deny the motion, because the protection of the double jeopardy clause does not come into play until there has been a conviction or an acquittal."], correct: "C" },
  { id: 4044, category: "Criminal Law and Procedure", question: "Police, who had probable cause to arrest a man for a series of armed robberies, obtained a warrant to arrest him. At 6 a.m. they surreptitiously entered the man's house and, with guns drawn, went to the man's bedroom, where they awakened him. Startled, the man asked, \"What's going on?\" and an officer replied, \"We've got you now.\" Another officer immediately asked the man if he had committed a particular robbery, and the man said that he had. The police then informed him that he was under arrest and ordered him to get dressed.\n\nCharged with robbery, the man has moved to suppress the use of his statement as evidence.\n\nWhat is the man's best argument for granting his motion?", answers: ["(A) The police did not give him the required Miranda warnings.", "(B) The statement was not voluntary.", "(C) He was not informed that he was under arrest until after he made the statement.", "(D) The police did not have a search warrant authorizing entry into the house."], correct: "A" },
  { id: 4045, category: "Criminal Law and Procedure", question: "Federal agents had a hunch that a local man was engaged in illegal gambling activities. An agent decided to enter the man's house while he was not at home and see what he could find. The agent discovered an envelope containing $5,000 in cash and an executive's business card. Returning the envelope to its place, the agent located and interviewed the executive, who admitted that he had paid the man $5,000 to settle a gambling debt; the executive also disclosed that the man regularly took illegal bets from the executive and several of his acquaintances. The agent then interviewed the acquaintances, who confirmed what the executive had told him. The agent then arranged to be introduced to the man at a local bar. After a few drinks, the man, unaware of the agent's identity, boasted that he was one of the biggest bookmakers in the state.\n\nThe agent testified to all of his investigation's discoveries before a grand jury, which returned an indictment against the man for illegal gambling activities, based solely on the agent's testimony. The man's attorney then filed a motion to dismiss the indictment, claiming that it rested on violations of the man's constitutional rights.\n\nShould the court grant the motion?", answers: ["(A) No, because dismissal of the indictment is not the appropriate remedy.", "(B) Yes, because much of the agent's testimony before the grand jury was inadmissible hearsay.", "(C) Yes, because of the agent's unlawful search of the man's home.", "(D) Yes, because of the agent's violation of the man's right to counsel."], correct: "A" },
  { id: 4046, category: "Criminal Law and Procedure", question: "A defendant was charged with the capital offense of first-degree murder, for which the only available penalties were death or life in prison without parole. During jury selection, the trial court, over the defendant's objection, granted the prosecution's for-cause challenge of five prospective jurors who indicated upon questioning by both parties that they personally were opposed to the death penalty and were unsure if they could ever vote to impose it. The jury convicted the defendant and, following a separate sentencing hearing, sentenced him to death.\n\nOn appeal, the defendant's only argument was that excusing the prospective jurors violated his federal constitutional right to be tried by a jury chosen from a fair cross section of the community.\n\nHow should the court of appeals rule on the conviction and the death sentence?", answers: ["(A) Affirm both.", "(B) Affirm the conviction, but reverse the death sentence and remand for a new sentencing hearing before a different jury.", "(C) Affirm the conviction, but reverse the death sentence and remand for resentencing to life in prison.", "(D) Reverse both."], correct: "A" },
  { id: 4047, category: "Criminal Law and Procedure", question: "Police responded to a call that shots had been heard coming from a certain house. Upon arriving at the house, the police looked through a window and saw a man lying on the living room floor. The police opened the front door, which was not locked, and found that the man had recently been shot in the back and was unconscious. An ambulance was called. While waiting for the ambulance, one officer walked through the house to see if anyone else was present. No one else was found, but the officer did see on the kitchen table clear bags of what he believed to be cocaine. The officer seized the bags, and laboratory tests later confirmed that the contents were cocaine.\n\nAfter the ambulance arrived a few minutes later and took the man to the hospital, the police went through the house and opened drawers trying to find the gun used in the shooting. No gun was found, but upon opening a drawer in an upstairs bedroom, the police found marijuana and seized it.\n\nLater investigation led to charging a young woman, who lived in the house, with unlawful possession of the cocaine and the marijuana. The young woman has filed a motion to suppress the use of both as evidence on the ground that the entry into the house and the searches were made without a warrant.\n\nHow should the court decide the young woman's motion?", answers: ["(A) Grant it as to the cocaine, but deny it as to the marijuana.", "(B) Deny it as to the cocaine, but grant it as to the marijuana.", "(C) Grant it as to both the cocaine and the marijuana.", "(D) Deny it as to both the cocaine and the marijuana."], correct: "B" },
  { id: 4048, category: "Criminal Law and Procedure", question: "A detective received information from an informant, who had given reliable information many times in the past, that a suspect was a narcotics dealer. Specifically, the informant said that, two months before, he had visited the suspect's apartment with one of the suspect's friends and that on that occasion he saw the suspect sell that friend some heroin. The detective knew that the informant, the suspect, and the friend of the suspect were all friends. Thereafter, the detective put all this information into an affidavit form, appeared before a magistrate, and secured a search warrant for the suspect's apartment. The search turned up a supply of heroin. The suspect's motion to suppress introduction of the heroin into evidence will most probably be", answers: ["(A) granted, because a search warrant cannot validly be issued solely on the basis of an informant's information.", "(B) granted, because the information supplied to the detective concerned an occurrence too remote in time to justify a finding of probable cause at the time of the search.", "(C) granted, because a search for \"mere evidence\" alone is improper and illegal.", "(D) denied, because the informant had proven himself reliable in the past and the information he gave turned out to be correct."], correct: "B" },
  { id: 4049, category: "Criminal Law and Procedure", question: "A defendant sold heroin to an addict. The addict was later stopped by two police officers for speeding 30 miles per hour over the speed limit. The officers required the addict to get out of the car. One of the officers told the addict he was arresting him pursuant to department policy of arresting all persons stopped for going more than 20 mph over the speed limit; that officer put the addict in handcuffs, escorted him to the patrol car, and kept watch over him there. The other officer searched the passenger compartment of the addict's car and found the heroin concealed under the rear seat. The defendant has now been charged with illegally selling the heroin found in the addict's car.\n\nThe defendant's motion to prevent introduction of the heroin into evidence will most probably be", answers: ["(A) granted, because the heroin was not in plain view.", "(B) granted, because the scope of the search was excessive.", "(C) denied, because the defendant has no standing to object to the search.", "(D) denied, because the search was proper as incident to a valid full custodial arrest."], correct: "C" },
  { id: 4050, category: "Criminal Law and Procedure", question: "A thief held up a drugstore at 10:30 at night, and drove away. His car broke down in an isolated area just outside the small city in which the crime occurred. The thief walked to the nearest house and asked the homeowner if he could stay until the next morning, explaining that he had been searching for his sister's home and had run out of gas. The homeowner agreed to let him sleep on a couch in the basement. During the course of the night, the homeowner began to doubt the story the thief had told him. Early the next morning, the homeowner called the police and said he was suspicious and frightened of a stranger whom he had allowed to stay the night. The police went immediately to the house to assist the homeowner and walked through the open front door. They found the thief and the homeowner drinking coffee in the kitchen. When they saw the thief, they realized he matched the description of the drugstore robber. They arrested the thief and in his jacket they found drugs taken during the robbery.\n\nThe thief moves to suppress the evidence of the drugs. If the court finds that the police did not have probable cause to believe the man was the thief until they saw him inside the homeowner's house and realized he matched the description, the court should", answers: ["(A) grant the motion, because, as a guest, the thief has sufficient standing to contest the entry of the house without a warrant.", "(B) grant the motion, because, as a guest, the thief has sufficient standing to contest the lack of probable cause at the time of the entry.", "(C) deny the motion, because the thief had no ownership or other possessory interest in the premises.", "(D) deny the motion, because the police had the permission of the owner to enter the house."], correct: "D" },
  { id: 4051, category: "Criminal Law and Procedure", question: "The police had, over time, accumulated reliable information that a drug dealer operated a large cocaine-distribution network, that he and his accomplices often resorted to violence, and that they kept a small arsenal of weapons in his home.\n\nOne day, the police received reliable information that a large brown suitcase with leather straps containing a supply of cocaine had been delivered to the drug dealer's home and that it would be moved to a distribution point the next morning. The police obtained a valid search warrant to search for and seize the brown suitcase and the cocaine and went to the drug dealer's house. The police knocked on the drug dealer's door and called out, \"Police. Open up. We have a search warrant.\" After a few seconds with no response, the police forced the door open and entered. Hearing noises in the basement, the police ran down there and found the drug dealer with a large brown suitcase with leather straps. They seized the suitcase and put handcuffs on the drug dealer. A search of his person revealed a switchblade knife and a .45-caliber pistol. The drug dealer cursed the police and said, \"You never would have caught me with the stuff if it hadn't been for that lousy snitch!\" In addition to charges relating to the cocaine in the suitcase, the drug dealer is charged with unlawful possession of weapons. The drug dealer moves pretrial to suppress the use as evidence of the weapons seized by the police and of the statement he made. As to the drug dealer's statement, his motion to suppress should be", answers: ["(A) granted, because the entry by forcing open the door was not reasonable.", "(B) granted, because the police failed to read the drug dealer his Miranda rights.", "(C) denied, because the statement was volunteered.", "(D) denied, because the statement was the product of a lawful public safety search."], correct: "C" },
  { id: 4052, category: "Criminal Law and Procedure", question: "Two state troopers, a man and a woman driving a single patrol car, lawfully stopped the driver of a van on the turnpike for exceeding the speed limit by four miles per hour. The male trooper approached the van to warn the driver to drive within the speed limit. The female trooper remained in the patrol car and ran a computer check of the license number of the driver's van; the computer check indicated that there was an outstanding warrant for the driver's arrest for unpaid traffic tickets. The male trooper therefore told the driver she was under arrest pursuant to the warrant, and searched her person. Then, while the driver waited next to the van, the trooper searched the van's front seat. He saw and seized ten glassine bags of heroin in a paper bag on that seat. Later, it was learned that the driver had paid the outstanding traffic tickets ten days earlier and the warrant had been quashed, but the clerk of the court had failed to update the computer, which continued to list the warrant as outstanding. The driver was charged with unlawful possession of heroin. Her attorney filed a motion to suppress the use as evidence of the heroin found in the van.\n\nShould the motion be granted?", answers: ["(A) No, because the troopers could reasonably rely on the computer report and the search was incident to arrest.", "(B) No, because troopers may lawfully search the passenger compartment of a car incident to a valid traffic stop.", "(C) Yes, because there was no arrest for the traffic violation and no lawful arrest could be made on the basis of the warrant.", "(D) Yes, because there was no probable cause or reasonable suspicion to believe drugs were in the car."], correct: "A" },
  { id: 4053, category: "Criminal Law and Procedure", question: "A bank robber handed a teller a handwritten note demanding money. Shortly thereafter, the defendant was arrested for the robbery. At the police station, the defendant was required, over his protest, to write out the words of the note and have his fingerprints taken. He was then, for the first time, allowed to telephone a lawyer, who thereafter represented him.\n\nThe prosecution, after introducing the robbers' note to the teller, also offers in evidence the defendant's writing of the words on the note at the request of the police. On appropriate action, the court should rule this", answers: ["(A) admissible.", "(B) inadmissible, because he was not advised that his handwriting sample could be admitted into evidence against him.", "(C) inadmissible, because he was not advised of his right to refuse to give a handwriting sample.", "(D) inadmissible, because he had not been informed he had a right to have counsel present."], correct: "A" },
  { id: 4054, category: "Criminal Law and Procedure", question: "A state grand jury investigating a murder learned that the key suspect might have kept a diary. The grand jury issued a subpoena duces tecum requiring the suspect to produce any diary. The subpoena made clear that the grand jury was seeking only the diary and not any testimony from the suspect. The suspect refused to produce the diary, citing the privilege against self-incrimination.\n\nUnder what circumstances, if any, could the grand jury compel production of the diary over the suspect's Fifth Amendment privilege?", answers: ["(A) It may compel production without granting immunity because the suspect was not compelled to write a diary.", "(B) It may compel production only if the suspect is granted use and derivative use immunity from the act of production.", "(C) It may compel production only if the suspect is granted transactional immunity.", "(D) It may not compel production of a private diary under any circumstances."], correct: "B" },
  { id: 4055, category: "Criminal Law and Procedure", question: "A state enacted a statute \"to regulate administratively the conduct of motor vehicle junkyard businesses in order to deter motor vehicle theft and trafficking in stolen motor vehicles or parts thereof.\" The statute requires a junkyard owner or operator \"to permit representatives of the Department of Motor Vehicles or of any law enforcement agency upon request during normal business hours to take physical inventory of motor vehicles and parts thereof on the premises.\" The statute also states that a failure to comply with any of its requirements constitutes a felony.\n\nPolice officers assigned to their city's Automobile Crimes Unit periodically visited all motor vehicle junkyards in town to make the inspections permitted by the statute. A junkyard owner conducted such a business in the city at issue. One summer day, the officers asked to inspect the vehicles on her lot. The junkyard owner said, \"Do I have a choice?\" The officers told her she did not. The officers conducted their inspection and discovered three stolen automobiles.\n\nThe junkyard owner is charged with receiving stolen property. The junkyard owner moves pretrial to suppress the evidence relating to the three automobiles on the ground that the inspection was unconstitutional. Her motion should be", answers: ["(A) sustained, because the statute grants unbridled discretion to law enforcement officers to make warrantless searches.", "(B) sustained, because the stated regulatory purpose of the statute is a pretext to circumvent the warrant requirement in conducting criminal investigations.", "(C) denied, because the statute deals reasonably with a highly regulated industry.", "(D) denied, because administrative searches of commercial establishments do not require warrants."], correct: "C" },
  { id: 4056, category: "Criminal Law and Procedure", question: "A marijuana farmer had been missing for several months. The sheriff's department received an anonymous tip that a rival marijuana farmer had buried the missing farmer in a hillside about 200 yards from the rival farmer's farmhouse. Sheriff's deputies went to the rival farmer's farm. They cut the barbed wire that surrounded the hillside and entered, looking for the grave. They also searched the adjacent fields on the rival farmer's farm that were within the area enclosed by the barbed wire and discovered clothing that belonged to the missing farmer hanging on a scarecrow. The rival farmer observed their discovery and began shooting. The deputies returned the fire. The rival farmer dashed to his pickup truck to escape. Unable to start the truck, he fled across a field toward the barn. A deputy tackled him just as he entered the barn.\n\nAs the rival farmer attempted to get up, the deputy pinned his arms behind his back. Another deputy threatened, \"Tell us what you did with the missing farmer or we'll lock you up and you'll see your family on welfare.\" The rival farmer responded that he had killed the missing farmer in a fight but did not report the incident because he did not want authorities to enter his land and discover his marijuana crop. Instead, he buried him behind the barn. The rival farmer was thereafter charged with murder. If the rival farmer moves to suppress his admission about killing his neighbor, the court should", answers: ["(A) grant the motion, because the rival farmer did not voluntarily waive his right to silence.", "(B) grant the motion, because the statement was the product of the warrantless entry and search of the rival farmer's farm.", "(C) deny the motion, because the deputy was in hot pursuit when he questioned the rival farmer.", "(D) deny the motion, because the rival farmer was questioned during a police emergency search."], correct: "A" },
  { id: 4057, category: "Criminal Law and Procedure", question: "A woman who is a computer whiz decided to dedicate herself to exposing persons who traffic in child pornography. She posted a number of sexually oriented photographs on her web site. The file for each photograph contained an embedded Trojan horse program. The defendant downloaded one of those photographs onto his personal computer. Using the embedded program, the woman entered the defendant's computer and found a file containing a pornographic photograph of a child. She copied the file and turned it over to a federal law enforcement agency. A federal agent told her that a successful prosecution would require more than one photograph and offered her a monetary reward for additional photos leading to a conviction of the defendant. The woman entered the defendant's computer again, and this time she found hundreds of child pornography photos, which she turned over to the federal agency.\n\nThe defendant is charged with multiple counts of violating federal statutes regarding child pornography. He moves to suppress the photographs that the woman discovered on his computer. The motion is based on both the Fourth Amendment and a federal statute forbidding interception of electronic communication without permission. The parties have stipulated that the woman's conduct in downloading photos from the defendant's computer violated the interception statute. How should the court rule on the defendant's motion to suppress?", answers: ["(A) Deny it as to all photographs.", "(B) Grant it as to all photographs, because the woman acted without probable cause.", "(C) Grant it as to all photographs, because the woman violated the federal interception statute.", "(D) Grant it only as to the second set of photographs."], correct: "D" },
  { id: 4058, category: "Criminal Law and Procedure", question: "A valid warrant was issued for a woman's arrest. The police learned that a person with the woman's name and physical description lived at a particular address. When police officers went to that address, the house appeared to be unoccupied: the windows and doors were boarded up with plywood, and the lawn had not been mowed for a long time. A neighbor confirmed that the house belonged to the woman but said that the woman had not been there for several months.\n\nThe officers knocked repeatedly on the front door and shouted, \"Police! Open up!\" Receiving no response, they tore the plywood off the door, smashed through the door with a sledgehammer, and entered the house. They found no one inside, but they did find an illegal sawed-off shotgun. Upon her return to the house a few weeks later, the woman was charged with unlawful possession of the shotgun.\n\nThe woman has moved to suppress the use of the shotgun as evidence at her trial. Should the court grant the motion?", answers: ["(A) No, because the officers acted in good faith under the authority of a valid warrant.", "(B) No, because the officers did not violate any legitimate expectation of privacy in the house since the woman had abandoned it.", "(C) Yes, because the officers entered the house by means of excessive force.", "(D) Yes, because the officers had no reason to believe that the woman was in the house."], correct: "D" },
  { id: 4059, category: "Criminal Law and Procedure", question: "A woman was subpoenaed to appear before a grand jury. When she arrived, she was taken into the grand jury room to be questioned. She answered preliminary questions about her name and address. She was then asked where she had been at a certain time on a specified night when a murder had occurred. Before answering the question, the woman said that she wanted to consult her attorney, who was waiting outside the grand jury room, and she was allowed to do so. When she returned to the grand jury room, she stated that she refused to answer the question because the answer might incriminate her.\n\nThe prosecutor believes that the woman's nephew committed the murder. The nephew has said that he was with the woman at the time of the murder, and the prosecutor believes that this alibi is false. The prosecutor does not believe that the woman is guilty of the murder, either as a principal or as an accomplice, although he does believe that the woman may be guilty of other crimes. The prosecutor wants to compel the woman to answer the question by whatever means will result in the least harm to the prosecution's case.\n\nWhich of the following steps should the prosecutor take to get the woman to answer the question?", answers: ["(A) Request the grand jury to order the woman to answer the question.", "(B) Ask the woman's attorney to explain to the woman that the rules of evidence do not apply in grand jury proceedings, and to advise her that she cannot refuse to testify.", "(C) Prepare the documents necessary to grant the woman immunity from any future use against her of her grand jury testimony or any evidence derived from it.", "(D) Prepare the documents necessary to grant the woman immunity from any future prosecution for any crime she might disclose in the course of her testimony."], correct: "C" },
  { id: 4060, category: "Criminal Law and Procedure", question: "A defendant was validly arrested for the murder of a store clerk and was taken to a police station where he was given Miranda warnings. When an interrogator asked the defendant, \"Do you understand your Miranda rights, and are you willing to give up those rights and talk to us?\" the defendant replied, \"Yes.\" When asked, \"Did you kill the clerk?\" the defendant replied, \"No.\" When asked, \"Where were you on the day the clerk was killed?\" the defendant replied, \"Maybe I should talk to a lawyer.\" The interrogator asked, \"Are you sure?\" and the defendant replied, \"I'm not sure.\" The interrogator then asked, \"Why would you want to talk with a lawyer?\" and the defendant replied, \"Because I killed the clerk. It was an accident, and I think I need a lawyer to defend me.\" At that point all interrogation ceased. Later, the defendant was formally charged with murdering the clerk.\n\nThe defendant has moved to suppress evidence of his statement \"I killed the clerk\" on the ground that this statement was elicited in violation of his Miranda rights.\n\nShould the defendant's motion be granted?", answers: ["(A) No, because although the defendant effectively asserted the right to counsel, the question \"Why would you want to talk with a lawyer?\" did not constitute custodial interrogation.", "(B) No, because the defendant did not effectively assert the right to counsel, and his conduct prior to making the statement constituted a valid waiver of his Miranda rights.", "(C) Yes, because although the defendant did not effectively assert the right to counsel, his conduct prior to making the statement did not constitute a valid waiver of his Miranda rights.", "(D) Yes, because the defendant effectively asserted the right to counsel, and the question \"Why would you want to talk with a lawyer?\" constituted custodial interrogation."], correct: "B" },
  { id: 4061, category: "Criminal Law and Procedure", question: "Two defendants were being tried together in federal court for bank robbery. The prosecutor sought to introduce testimony from the first defendant's prison cellmate. The cell-mate would testify that the first defendant had admitted to the cellmate that he and the second defendant had robbed the bank. The prosecutor asked the court to instruct the jury that the cellmate's testimony could be considered only against the first defendant.\n\nCan the cellmate's testimony be admitted in a joint trial over the second defendant's objection?", answers: ["(A) No, because the first defendant made the statement without Miranda warnings.", "(B) No, because the limiting instruction cannot ensure that the jury will not consider the testimony in its deliberations regarding the second defendant.", "(C) Yes, because the first defendant's statement was a declaration against penal interest.", "(D) Yes, because the limiting instruction sufficiently protects the second defendant."], correct: "B" },
  { id: 4062, category: "Criminal Law and Procedure", question: "A prosecutor presented to a federal grand jury the testimony of a witness in order to secure a defendant's indictment for theft of government property. The prosecutor did not disclose to the grand jury that the witness had been convicted four years earlier of perjury. The grand jury returned an indictment, and the defendant pleaded not guilty.\n\nShortly thereafter, the prosecutor took the case to trial, calling the witness to testify before the jury. The prosecutor did not disclose the witness's prior perjury conviction until the defense was preparing to rest. Defense counsel immediately moved for a mistrial, which the court denied. Instead, the court allowed the defense to recall the witness for the purpose of impeaching him with this conviction, but the witness could not be located. The court then allowed the defense to introduce documentary evidence of the witness's criminal record to the jury before resting its case. The jury convicted the defendant.\n\nThe defendant has moved for a new trial, arguing that the prosecutor's failure to disclose the witness's prior conviction in a timely manner violated the defendant's right to due process of law.\n\nIf the court grants the defendant's motion, what will be the most likely reason?", answers: ["(A) The defendant was unable to cross-examine the witness about the conviction.", "(B) The prosecutor failed to inform the grand jury of the witness's conviction.", "(C) The court found it reasonably probable that the defendant would have been acquitted had the defense had timely access to the information about the witness's conviction.", "(D) The court found that the prosecutor had deliberately delayed disclosing the witness's conviction to obtain a strategic advantage."], correct: "C" },
  { id: 4063, category: "Criminal Law and Procedure", question: "After a defendant was indicted on federal bank fraud charges and released on bail, his attorney filed notice of the defendant's intent to offer an insanity defense. The prosecutor then enlisted the help of a forensic psychologist who was willing to participate in an \"undercover\" mental examination of the defendant. The psychologist contacted the defendant and pretended to represent an executive personnel agency. She told the defendant about an attractive employment opportunity and invited him to a \"preliminary screening interview\" to determine his qualifications for the job. As part of the purported screening process, the psychologist gave the defendant psychological tests that enabled her to form a reliable opinion about his mental state at the time of the alleged offense.\n\nWhat is the strongest basis for a defense objection to the psychologist's testimony regarding the defendant's mental state?", answers: ["(A) The Fourth Amendment prohibition against unreasonable searches and seizures.", "(B) The Fifth Amendment privilege against compelled self-incrimination.", "(C) The Sixth Amendment right to the assistance of counsel.", "(D) The federal common law privilege for confidential communications between psychotherapist and patient."], correct: "C" },
  { id: 4064, category: "Criminal Law and Procedure", question: "A police officer had a hunch, not amounting to probable cause or reasonable suspicion, that a man was a drug dealer. One day while the officer was on highway patrol, her radar gun clocked the man's car at 68 mph in an area where the maximum posted speed limit was 65 mph. The officer's usual practice was not to stop a car unless it was going at least 5 mph over the posted limit, but contrary to her usual practice, she decided to stop the man's car in the hope that she might discover evidence of drug dealing. After she stopped the car and announced that she would be writing a speeding ticket, the officer ordered the man and his passenger to step out of the car. When the passenger stepped out, the officer saw that the passenger had been sitting on a clear bag of what the officer immediately recognized as marijuana. The officer arrested both the man and the passenger for possession of marijuana.\n\nAt their joint trial, the man and the passenger claim that their Fourth Amendment rights were violated because the officer improperly (1) stopped the car for speeding as a pretext for investigating a hunch rather than for the stated purpose of issuing a traffic ticket and (2) ordered the passenger to step out of the car even though there was no reason to believe that the passenger was a criminal or dangerous.\n\nAre the man and the passenger correct?", answers: ["(A) No, as to both the stop of the car and the officer's order that the passenger step out of the car.", "(B) No as to the stop of the car, but yes as to the officer's order that the passenger step out of the car.", "(C) Yes as to the stop of the car, but no as to the officer's order that the passenger step out of the car.", "(D) Yes, as to both the stop of the car and the officer's order that the passenger step out of the car."], correct: "A" },
  { id: 4065, category: "Criminal Law and Procedure", question: "Police officers responding to phone calls of complaining neighbors noticed several broken windows in a home, glass on the ground, and a blood-stained shirt on the front porch. Through a window, the officers saw a man, whose hands were bleeding, shouting and throwing things, but no one else appeared to be present in the home.\n\nWhen the officers knocked on the door, the man refused to respond. The officers then asked if he needed medical assistance. The man told them to leave and not come back unless they had a warrant. The officers then entered the home, and the man pointed a shotgun at them. The officers withdrew but later arrested the man for felony assault on a police officer.\n\nAlleging that the warrantless entry violated the Fourth Amendment, the man has moved to suppress the officers' testimony at trial.\n\nShould the court grant the motion to suppress?", answers: ["(A) No, because the man lacks standing to complain of an entry under the emergency aid exception to the Fourth Amendment.", "(B) No, because the warrantless entry was reasonable under the emergency aid exception to the Fourth Amendment.", "(C) Yes, because officers cannot use the emergency aid exception to justify a warrantless entry when only the suspect himself needs aid.", "(D) Yes, because the emergency aid exception does not apply when a homeowner clearly and unambiguously invokes his right to a warrant."], correct: "B" },
  { id: 4066, category: "Criminal Law and Procedure", question: "Police officers received a tip that drug dealing was occurring at a certain ground-floor duplex apartment. They decided to stake out the apartment. The stakeout revealed that a significant number of people visited the apartment for short periods of time and then left. A man exited the apartment and started to walk briskly away. The officers grabbed the man and, when he struggled, wrestled him to the ground. They searched him and found a bag of heroin in one of his pockets. After discovering the heroin on the man, the police decided to enter the apartment. They knocked on the door, which was opened by the woman who lived there. The police asked if they could come inside, and the woman gave them permission to do so. Once inside, the officers observed several bags of heroin on the living room table. The woman is charged with possession of the heroin found on the living room table. She moves pretrial to suppress the heroin on the ground that it was obtained by virtue of an illegal search and seizure.\n\nShould the woman's motion be granted?", answers: ["(A) No, because the tip together with the heroin found in the man's pocket provided probable cause for the search.", "(B) No, because the woman consented to the officers' entry.", "(C) Yes, because the officers' decision to enter the house was the fruit of an illegal search of the man.", "(D) Yes, because the officers did not inform the woman that she could refuse consent."], correct: "B" },
  { id: 4067, category: "Criminal Law and Procedure", question: "Police received information from an undercover police officer that she had just seen two men (whom she described) in a red pickup truck selling marijuana to schoolchildren near the city's largest high school. A few minutes later, two police officers saw a pickup truck fitting the description a half block from the high school. The driver of the truck matched the description of one of the men described by the undercover officer.\n\nThe only passenger was a young woman who was in the back of the truck. The police saw her get out and stand at a nearby bus stop. They stopped the truck and asked the driver to exit the car; they then searched the driver's person. In the pocket of the driver's jacket, the police found a small bottle of pills that they recognized as narcotics. They arrested the driver and handcuffed him to the back of the police car. The police then broke open a locked toolbox attached to the flatbed of the truck and found a small sealed envelope inside. They opened it and found marijuana. They also found a quantity of cocaine in the glove compartment.\n\nAfter completing their search of the driver and the truck, the police went over to the young woman and searched her purse. In her purse, they found a small quantity of heroin. Both the driver and the young woman were arrested and charged with unlawful possession of narcotics.\n\nIf the driver moves to suppress the use as evidence of the marijuana and cocaine found in the search of the truck, the court should", answers: ["(A) grant the motion as to both the marijuana and the cocaine.", "(B) grant the motion as to the marijuana but deny it as to the cocaine.", "(C) deny the motion as to the marijuana but grant it as to the cocaine.", "(D) deny the motion as to both the marijuana and the cocaine."], correct: "D" },
  { id: 4068, category: "Criminal Law and Procedure", question: "After reading a description of a person who had committed a rape, a parole officer noted that the description resembled one of his parolees. The officer called the parolee and asked him to drop by his office. The parolee came to the office and, after about 30 minutes of questioning, admitted having committed the rape. At no time did the officer give the parolee Miranda warnings.\n\nThe parolee was charged with rape and has moved to suppress his statement to the parole officer.\n\nShould the court grant the motion to suppress?", answers: ["(A) No, because a parolee has no privilege against self-incrimination.", "(B) No, because the parolee was not in custody.", "(C) Yes, because Miranda warnings are required before interrogation by law enforcement officers.", "(D) Yes, because the parolee's statements were compelled, as he could reasonably believe that he was required to answer questions asked by his parole officer."], correct: "B" },
  { id: 4069, category: "Criminal Law and Procedure", question: "A woman was charged with stealing from her employer. Her lawyer advised her to plead guilty, citing overwhelming evidence that included a video recording of her confession and multiple witnesses. The woman repeatedly asked whether a guilty plea might lead to her deportation because she had come to the United States as a child and had lawful permanent resident status but not citizenship. The lawyer assured the woman that the charge would not result in deportation and emphasized the unusually favorable terms of the plea bargain. The woman accepted the plea offer.\n\nAt the end of the woman's short prison term, immigration authorities informed her that the conviction required her deportation. The woman filed a motion to vacate the plea, citing ineffective assistance of counsel.\n\nHow is the court likely to rule?", answers: ["(A) Counsel was ineffective, and under the circumstances, the woman suffered prejudice even though there was only a remote chance of success at trial.", "(B) Counsel was ineffective, but the woman suffered no prejudice because she admitted guilt when tendering the plea.", "(C) Counsel was not ineffective, because a criminal attorney is not required to provide advice about the collateral consequences of conviction.", "(D) Counsel was not ineffective, because there was overwhelming evidence of guilt."], correct: "A" },
];
...
const TOPICS = {
  ...
  "Criminal Law": { label: "Crim Law", color: "#9b59b6", icon: "🔒", questions: CRIMINAL_QUESTIONS },
};
